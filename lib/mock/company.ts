...
export const INGEST_SOURCES: IngestSource[] = [
  ...
  { id: "src-manageengine", system: "ManageEngine OpManager", category: "Network monitoring", status: "connected", entitiesContributed: 1_460, factsContributed: 402_000, lastSyncAt: minutesAgo(2), latencySeconds: 95 },
